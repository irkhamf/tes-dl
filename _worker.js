...
let Pswd = "trojan";
const proxyIPs = ["quiz.int.vidio.com.server-sg.paok17.workers.dev"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk
let cn_hostnames = [''];
